...
# Output:
#   returns true if x and y are equal, and theta is equal or both above pi/2 radians
...
def test_tag_in_world_to_tag_in_camera():
    ...
    assert tag_in_camera_is_correct(ans, [0, 1, 0])
    ...
    assert tag_in_camera_is_correct(ans, [5, 5, mu.to_rad(45)])
