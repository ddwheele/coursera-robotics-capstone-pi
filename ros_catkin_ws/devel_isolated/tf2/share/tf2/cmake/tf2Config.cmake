...
if("TRUE" STREQUAL "TRUE")
  set(tf2_SOURCE_PREFIX /home/pi/ros_catkin_ws/src/geometry2/tf2)
...
if(NOT "/home/pi/ros_catkin_ws/src/geometry2/tf2/include;/usr/include " STREQUAL " ")
  set(tf2_INCLUDE_DIRS "")
  set(_include_dirs "/home/pi/ros_catkin_ws/src/geometry2/tf2/include;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tf2' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/ros_catkin_ws/src/geometry2/tf2/${idir}'.  Ask the maintainer 'Tully Foote <tfoote@osrfoundation.org>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/pi/ros_catkin_ws/devel_isolated/tf2/lib;/opt/ros/indigo/lib)
