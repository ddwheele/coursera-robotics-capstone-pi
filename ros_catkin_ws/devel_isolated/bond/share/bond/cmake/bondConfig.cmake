...
if("TRUE" STREQUAL "TRUE")
  set(bond_SOURCE_PREFIX /home/pi/ros_catkin_ws/src/bond_core/bond)
  set(bond_DEVEL_PREFIX /home/pi/ros_catkin_ws/devel_isolated/bond)
...
if(NOT "/home/pi/ros_catkin_ws/devel_isolated/bond/include " STREQUAL " ")
  set(bond_INCLUDE_DIRS "")
  set(_include_dirs "/home/pi/ros_catkin_ws/devel_isolated/bond/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'bond' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/ros_catkin_ws/src/bond_core/bond/${idir}'.  Ask the maintainer 'Esteve Fernandez <esteve@osrfoundation.org>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/pi/ros_catkin_ws/devel_isolated/bond/lib;/opt/ros/indigo/lib)
