...
if("TRUE" STREQUAL "TRUE")
  set(camera_calibration_parsers_SOURCE_PREFIX /home/pi/ros_catkin_ws/src/image_common/camera_calibration_parsers)
...
if(NOT "/home/pi/ros_catkin_ws/src/image_common/camera_calibration_parsers/include " STREQUAL " ")
  set(camera_calibration_parsers_INCLUDE_DIRS "")
  set(_include_dirs "/home/pi/ros_catkin_ws/src/image_common/camera_calibration_parsers/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'camera_calibration_parsers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/ros_catkin_ws/src/image_common/camera_calibration_parsers/${idir}'.  Ask the maintainer 'Jack O'Quin <jack.oquin@gmail.com>, Vincent Rabaud <vincent.rabaud@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/pi/ros_catkin_ws/devel_isolated/camera_calibration_parsers/lib;/opt/ros/indigo/lib)
