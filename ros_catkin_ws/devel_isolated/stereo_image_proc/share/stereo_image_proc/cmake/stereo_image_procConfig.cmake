...
if("TRUE" STREQUAL "TRUE")
  set(stereo_image_proc_SOURCE_PREFIX /home/pi/ros_catkin_ws/src/image_pipeline/stereo_image_proc)
  set(stereo_image_proc_DEVEL_PREFIX /home/pi/ros_catkin_ws/devel_isolated/stereo_image_proc)
...
if(NOT "/home/pi/ros_catkin_ws/devel_isolated/stereo_image_proc/include;/home/pi/ros_catkin_ws/src/image_pipeline/stereo_image_proc/include " STREQUAL " ")
  set(stereo_image_proc_INCLUDE_DIRS "")
  set(_include_dirs "/home/pi/ros_catkin_ws/devel_isolated/stereo_image_proc/include;/home/pi/ros_catkin_ws/src/image_pipeline/stereo_image_proc/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'stereo_image_proc' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/ros_catkin_ws/src/image_pipeline/stereo_image_proc/${idir}'.  Ask the maintainer 'Vincent Rabaud <vincent.rabaud@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/pi/ros_catkin_ws/devel_isolated/stereo_image_proc/lib;/opt/ros/indigo/lib)
