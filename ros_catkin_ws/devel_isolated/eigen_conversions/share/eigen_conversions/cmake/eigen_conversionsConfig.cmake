...
if("TRUE" STREQUAL "TRUE")
  set(eigen_conversions_SOURCE_PREFIX /home/pi/ros_catkin_ws/src/geometry/eigen_conversions)
  set(eigen_conversions_DEVEL_PREFIX /home/pi/ros_catkin_ws/devel_isolated/eigen_conversions)
...
if(NOT "/home/pi/ros_catkin_ws/src/geometry/eigen_conversions/include;/usr/include/eigen3;/opt/ros/indigo/include " STREQUAL " ")
  set(eigen_conversions_INCLUDE_DIRS "")
  set(_include_dirs "/home/pi/ros_catkin_ws/src/geometry/eigen_conversions/include;/usr/include/eigen3;/opt/ros/indigo/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'eigen_conversions' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/ros_catkin_ws/src/geometry/eigen_conversions/${idir}'.  Ask the maintainer 'Tully Foote <tfoote@osrfoundation.org>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/pi/ros_catkin_ws/devel_isolated/eigen_conversions/lib;/opt/ros/indigo/lib)
